...
- [All data available, pip and tars](#all-data-available-pip-and-tars)
  - [Bloodmeal COi Sequences](#bloodmeal-coi-sequences)
  - [WNV test status by mosquito
    pool](#wnv-test-status-by-mosquito-pool)
  - [Overlap by loc_year_month +
    mosq_species](#overlap-by-loc_year_month--mosq_species)
  ...
  - [Stacked barplot of host composition by loc_positives (0 vs
    1)](#stacked-barplot-of-host-composition-by-loc_positives-0-vs-1)
  - [Fisher’s Exact Tests](#fishers-exact-tests)
    - [House finch over-represented in locations with \>1 positive
      pool?](#house-finch-over-represented-in-locations-with-1-positive-pool)
    - [Song sparrow over-represented in locations with \>1 positive
      pool?](#song-sparrow-over-represented-in-locations-with-1-positive-pool)
    - [Maybe its the mosquito? YES](#maybe-its-the-mosquito-yes)
  - [GLM Mosquito (and Song Sparrow)](#glm-mosquito-and-song-sparrow)
  - [GLM Mosquito (and house finch)](#glm-mosquito-and-house-finch)
    - [I would explore host/mosquito species in pool a little
      more…](#i-would-explore-hostmosquito-species-in-pool-a-little-more)
- [Cx_pipiens_sl only](#cx_pipiens_sl-only)
  ...
  - [Pip - Collapse to counts](#pip---collapse-to-counts)
    - [Narrow format only one host_species
      column…](#narrow-format-only-one-host_species-column-1)
    - [Wide format counts](#wide-format-counts-1)
  ...
  - [Pip - Fisher’s Exact Tests](#pip---fishers-exact-tests)
    - [House finch over-represented in locations with \>1 positive
      pool?](#house-finch-over-represented-in-locations-with-1-positive-pool-1)
    - [Song sparrow over-represented in locations with \>1 positive
      pool?](#song-sparrow-over-represented-in-locations-with-1-positive-pool-1)
  - [Pip - GLM Song Sparrow](#pip---glm-song-sparrow)
  - [Pip - GLM house finch](#pip---glm-house-finch)

# All data available, pip and tars

Uniting WNV and Bloodmeal COi Sequences
...
## Overlap by loc_year_month + mosq_species
...
<img src="Wk3_bloodmeal_WNV_files/figure-gfm/unnamed-chunk-2-1.png" style="display: block; margin: auto auto auto 0;" />
...
<img src="Wk3_bloodmeal_WNV_files/figure-gfm/unnamed-chunk-2-2.png" style="display: block; margin: auto auto auto 0;" />
...
### House finch over-represented in locations with \>1 positive pool?
...
### Song sparrow over-represented in locations with \>1 positive pool?
...
### I would explore host/mosquito species in pool a little more…
